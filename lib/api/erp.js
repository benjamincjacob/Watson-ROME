...
module.exports = {
	...
	searchDiscovery: function(params, callback) {
		...
		discovery.query(('d76544dc-6d9f-4b3c-82aa-65c6d807d649', '03fbf02b-c7c2-4daa-8f14-30c9376279c4', params), function(error, data) {
			  console.log(JSON.stringify(data, null, 2));
			  if (error) {
				  callback(error)
			  } else {
				  debug('Discovery result text: %s',data.results[0].text);
				  callback(null, {
					  DiscoveryResult: data.results[0].text
				  });
			  }
			});
	}
